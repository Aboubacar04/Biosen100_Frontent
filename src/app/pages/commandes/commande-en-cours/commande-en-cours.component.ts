...
export class CommandeEnCoursComponent implements OnInit, OnDestroy {
  ...
  loadCommandes(): void {
    ...
    this.commandeService.getEnCours(params)
      .pipe(takeUntil(this.destroy$))
      .subscribe({
        ...
        error: (err) => {
          console.error('Erreur chargement commandes en cours:', err);
          this.loading = false;
          this.cdr.markForCheck();
        },
      });
